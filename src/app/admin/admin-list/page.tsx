...
const AdminList = () => {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_BaseUrl}/admin/list`,
      );
  ...
  const deleteAdmin = async () => {
    ...
    console.log("Deleting admin with ID:", selectedAdminId);
    try {
      await axios.delete(
        `${process.env.NEXT_PUBLIC_BaseUrl}/admin/delete/${selectedAdminId}`,
